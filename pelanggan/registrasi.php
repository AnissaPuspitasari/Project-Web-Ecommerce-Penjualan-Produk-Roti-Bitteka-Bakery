...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  $check_query = "SELECT * FROM tbl_pengguna WHERE email='$email'";
  ...
  if (mysqli_num_rows($check_result) > 0) {
    ...
    $insert_query = "INSERT INTO tbl_pengguna (nama_lengkap, no_hp, email, kata_sandi) 
    VALUES ('$nama', '$nomor_hp', '$email', '$hashed_password')";


    if (mysqli_query($conn, $insert_query)) {
      echo "<script>alert('Registrasi berhasil!'); window.location='login.php';</script>";
    } else {
      echo "<script>alert('Terjadi kesalahan, coba lagi.'); window.location='registrasi.php';</script>";
    }
  }
}
?>
...
<head>
  ...
  <title>Registrasi - BitTeka</title>
...
<body>
  ...
  <div class="login-wrapper">
    <div class="login-container">
      ...
      <h2>Buat Akun BitTeka Bakery</h2>
      <p>Yuk daftar dan nikmati roti favoritmu! 🥖</p>
