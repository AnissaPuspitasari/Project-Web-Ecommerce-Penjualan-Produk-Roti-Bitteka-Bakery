...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  $stmt = mysqli_prepare($conn, "SELECT * FROM tbl_pengguna WHERE email=?");
  ...
  if (mysqli_num_rows($result) == 1) {
    ...
    if (password_verify($password, $data['kata_sandi'])) {
      $_SESSION['user'] = $data;
      header("Location: order.php"); // Langsung ke halaman order
      exit();
    } else {
...
<body>
  ...
  <div class="login-wrapper">
    <div class="login-container">
      ...
      <h2>Selamat Datang di BitTeka Bakery</h2>
      <p>Login untuk memesan roti favoritmu! 🍞</p>
